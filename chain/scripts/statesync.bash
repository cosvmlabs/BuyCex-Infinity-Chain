...
# Assumes that ~/.cvmd doesn't exist
# can be modified to suit your purposes if ~/.cvmd does already exist
...
# Initialize chain.
cvmd init test --chain-id evmos_9000-1
...
# Start chain.
cvmd start --x-crisis-skip-assert-invariants 
